...
class GeneratorReporter(Reporter):
    def __init__(self, logger: "Logger | None" = None, cache: "Path | None" = None, redo: "bool" = False, cached: "bool" = True, generator: "ReportGenerator | None" = None) -> None:
    ...
    def report(self,
        ...
        outFile = self.cache / "reports" / oldRelease.project / \
            f"{oldRelease}&{newRelease}.txt" if self.cached else None
