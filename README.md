...
[AexPy](https://github.com/StardustDL/aexpy) */eɪkspaɪ/* is **A**pi **EX**plorer in **PY**thon for detecting API breaking changes in Python packages. Explore [APIs of AexPy releases](https://aexpy.netlify.app/projects/aexpy), and [APIs of main branch](https://aexpy.netlify.app/?url=https://stardustdl.github.io/aexpy/main.json) by **AexPy** itself.
